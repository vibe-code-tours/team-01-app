    ...
    <aside className="bg-[#0B2545] min-h-full w-64 flex flex-col border-r border-white/5">
      ...
      <div className="p-3 mt-auto">
        <div className="border-t border-white/10 pt-3">
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-white/30 hover:bg-white/5 hover:text-white/60 transition-all duration-150"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
